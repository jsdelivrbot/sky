...
@section('content')
            ...
            <div class="portlet light portlet-fit bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark bold uppercase">infinity</span>
                    </div>
                    <div class="actions">
                        <div class="btn-group">
                            <a class="btn dark btn-outline btn-circle btn-sm" href="{{url('/admin/infinity/create')}}">
                                Add
                            </a>
                        </div>
                    </div>
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            @foreach($items as $item)
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-sm-12">
                                            <a href="{{url("admin/infinity/$item->id/edit")}}"
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <form onsubmit='return ConfirmDelete()' method="post"
                                                  action="{{url("admin/infinity/$item->id")}}">
                                                {{ method_field('DELETE') }}
                                                {{csrf_field()}}
    ...
    <script>
        ...
        $(".infinity").addClass("open active").css("display", "block");
    </script>
